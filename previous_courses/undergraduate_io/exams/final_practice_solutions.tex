...
\begin{questions}
	...
	\begin{itemize}
		...
		\item a definition or brief explanation (i.e. one or a few words)
	\end{itemize}
	\vspace{11pt}
	\begin{parts}
		\part Hold-up problem
		
		
		\part E.g. eliminate double marginalization
	...
	\begin{parts}
		...
		Marginal revenue is:
		\begin{gather*}
		MR = 80 - 2q \text{ if } q < 42.5 \\
		MR = \frac{155}{3} - \frac{2q}{3} \text{ if } q >42.5
		\end{gather*}
		...
		\text{Profits} = 32.5 \times 47.5 - 32.5 \times 15 = 1056.25
		\end{gather*}
		
				Case 1: $q > 42.5$
		\begin{gather*}
		\frac{155}{3} - \frac{2q}{3} = 15 \implies q = 55 \implies p = 33.33 \\
		\text{Profits} = 55 \times 33.33 - 55 \times 15 = 1008.15
		\end{gather*}
		
		The Firm will choose Case 1.
...
\begin{parts}
	...
	\frac{d \pi_1}{d q_1} = 0 : 50 - 6q_1 = 0 \implies q_1 = \frac{50}{6}  
	\end{gather*}
	%\vspace{500pt}
	%\answerline[answer]
...
\begin{parts}
	...
	\frac{d \pi_m}{dw} = 0 : w = 4.5
	\end{gather*}
	
	Then,
	\begin{gather*}
	\pi_m = (4.5-1)1.75 = 6.125 \\
	\pi_r = (6.25-4.5)1.75 =3.0625
	\end{gather*}
So, joint profits are: 9.1875.
	
	\part Joint profits will be higher under vertical integration. Under vertical separation the retailer's price is too high due to double marginalization.
\end{parts}
\end{questions}
