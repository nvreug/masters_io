...
\begin{wideitemize}
	\item \textbf{Idea:} Start at demand = 0 and keep lowering prices so long as $MR \geq MC$. 
\end{wideitemize}
\end{frame}
...
\begin{frame}{Using the elasticity rule}
		\begin{wideitemize}
			...
			\item It turns out it is really useful for real-world empirical applications.
			\begin{wideitemize}
				\vspace{11pt}
