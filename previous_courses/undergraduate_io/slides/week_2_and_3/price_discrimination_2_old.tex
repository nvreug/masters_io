...
\begin{frame}{Price discrimination: self-selection}
	\begin{wideitemize}
		...
		\end{wideitemize}
		\item We will now discuss two types of \textbf{price discrimination by self-selection}.
		\begin{wideitemize}
			\vspace{11pt}
...
\begin{frame}{Self-selection: versioning}
	\begin{wideitemize}
		...
		\item \underline{19th century French railcars}: how to prevent wealthy passengers from choosing third-class tickets rather than second-class tickets?
...
\begin{frame}{Self-selection: versioning, example}
	\begin{wideitemize}
		\item \textbf{Solution:}
		\item Idea: each type of consumer will \underline{self-select} into the version with the \underline{highest consumer surplus} (consumer surplus=willingness-to-pay - price). E.g. consumer1 buys the full version if:
		\begin{align*}
			\text{consumer 1: } &1500-p_{full} \geq 800 - p_{stripped-down}
		\end{align*}
		\item 1. Find the profit from selling only the full version for 1500.
		\vspace{11pt}
		\begin{wideitemize}
...
\begin{frame}{Self-selection: versioning}
	\begin{wideitemize}
		...
		\begin{align*}
			...
			\text{Consumer type 2: \hspace{11pt}} &500-p_{full} \leq 600 - p_{stripped-down} &(IC2)
		\end{align*}
		...
		\begin{align*}
			...
			\text{Consumer type 2: \hspace{11pt}} &600 - p_{stripped-down} \geq 0 &(PC2)
		\end{align*}
...
\begin{frame}{Additional question: (Cabral)}
		\begin{wideitemize}
		\item \textbf{Example}: Selling airline tickets, and there are two potential versions. Costs = 0.
		\begin{table}
			\begin{tabular}{|l|c|c|c|}
				\hline
				\textbf{Type}&  \textbf{Number of users} & \multicolumn{2}{c}{\textbf{Willingness to pay}} \\
				\hline
			...
			\end{tabular}
		\end{table}
		\item \textbf{Questions} What is the profit if:
		\item 1. We can perfectly price discriminate?
		\item 2. Charge \$800 for the not restricted ticket, \$300 for the restricted ticket?
		\item 3. Charge \$700 for the not restricted ticket, \$300 for the restricted ticket?
		\item 4. Explain why the profits in Part 4 are greater than Part 3.
	\end{wideitemize}
\end{frame}
...
\begin{frame}{Additional question: (Cabral)}
	\begin{wideitemize}
		...
		\end{table}
		\item \textbf{Questions} What is the profit if:
		\item 1. We can perfectly price discriminate? A: 11500
		\item 2. Charge \$800 for the not restricted ticket, \$300 for the restricted ticket? A: 6000
		\item 3. Charge \$700 for the not restricted ticket, \$300 for the restricted ticket? A:10000
		\item 4. Explain why the profits in Part 4 are greater than Part 3. A: The incentive constraint for the high types is violated in part 3.
	\end{wideitemize}
\end{frame}
