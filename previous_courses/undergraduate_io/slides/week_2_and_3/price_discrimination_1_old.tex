...
\begin{frame}{Price discrimination: selection by indicators - more on previous question}
	\begin{wideitemize}
		\item \textbf{Setup:}
		\item Market 1 demand: $q_1 = 12 - 2p_1$
		\item Market 2 demand: $q_2 = 4 -p_2$
		\item Marginal cost = 1
		\item Before, we found that the uniform price/quantity is $Q=6.5,p=3.16667$. 
		\item Before, we found that under price discrimination, $q_1=5,p_1=3.5$ and $q_2=1.5,p_2=2.5$.
		\item \textbf{Questions:} 
		\item 1. How does consumer surplus change from uniform pricing to price discrimination?
		\item 2. How does the total surplus change from uniform pricing to price discrimination?
		\item 3. Is there an \textit{equity-efficiency tradeoff}?
	\end{wideitemize}
\end{frame}
...
\begin{frame}{Price discrimination: selection by indicators - more on previous question}
	\begin{wideitemize}
		...
		\begin{wideitemize}
			\vspace{11pt}
			\item \underline{Uniform pricing} (Q=6.5, p=3.1667):
			\item Market 1: $q_1=12-2*3.1667=5.67$
					\begin{wideitemize}
			\item So, $CS_1 = 0.5 \times 5.67 \times (6-3.1667) = 8.03$
				\end{wideitemize}
			\item Market 2: $q_2=4-3.1667=0.8333$
					\begin{wideitemize}
			\item So, $CS_2 = 0.5 \times 0.8333 \times (4-3.1667)=0.347$
				\end{wideitemize}
			\item Total CS = $CS_1+CS_2=8.03+0.347=8.38$.
		\end{wideitemize}
	\end{wideitemize}
\end{frame}
...
\begin{frame}{Price discrimination: selection by indicators - more on previous question}
	\begin{wideitemize}
		...
		\begin{wideitemize}
			\vspace{11pt}
			\item \underline{Discriminatory pricing} ($q_1=5,p_1=3.5$ and $q_2=1.5,p_2=2.5$):
			\item Market 1: 
			\begin{wideitemize}
				\item So, $CS_1 = 0.5 \times 5 \times (6-3.5) = 6.25$
			\end{wideitemize}
			\item Market 2: 
			\begin{wideitemize}
				\item So, $CS_2 = 0.5 \times 1.5 \times (4-2.5)=1.125$
			\end{wideitemize}
			\item Total CS = $CS_1+CS_2=6.25+1.125=7.375$.
			\item So, consumer surplus \underline{falls} moving from uniform to discriminatory pricing.
		\end{wideitemize}
	\end{wideitemize}
\end{frame}
...
\begin{frame}{Price discrimination: selection by indicators - more on previous question}
	\begin{wideitemize}
		...
		\begin{wideitemize}
			\vspace{11pt}
			\item \underline{Uniform pricing}
			\begin{wideitemize}
				\item We computed PS and CS in previous questions.
				\item $TS=CS+PS=8.38+14.08=22.46$
			\end{wideitemize}
					\item \underline{Discriminatory pricing}
			\begin{wideitemize}
				\item We computed PS and CS in previous questions.
				\item $TS=CS+PS=7.375+14.75=22.125$
			\end{wideitemize}
		\end{wideitemize}
	\end{wideitemize}
\end{frame}
...
\begin{frame}{Price discrimination: selection by indicators - more on previous question}
	\begin{wideitemize}
		\item \textbf{Solution:} 
		\item 3. Is there an equity-efficiency tradeoff?
		\begin{wideitemize}
			\vspace{11pt}
			\item More efficient: does total surplus increase?
			\item More equitable: does consumer surplus increase? (note: under price discrimination, profits will never decrease)
			\item Here, both TS and CS decrease. Therefore, there is no tradeoff, since price discrimination is less efficient (total surplus decreases) but also consumers are worse off.
		\end{wideitemize}
	\end{wideitemize}
\end{frame}

\begin{frame}{Price discrimination: book example}
	\begin{wideitemize}
		\item \textbf{Setup:}
		\item Selling a book in Europe and US markets.
		\item Marginal cost = 4
		\item US demand: $p_u=36-4q_u$
		\item Europe demand: $p_e=24-4q_e$
		\item \textbf{Questions:} 
		\item 1. What is the optimal uniform price?
		\item 2. What is the optimal prices under selection by indicators?
	\end{wideitemize}
\end{frame}
