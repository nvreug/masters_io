...
\begin{frame}{Collusion and Price Wars: Motivation}
	\begin{wideitemize}
		...
		\item These agreements are generically referred to as \textbf{collusion}. \pause
		\begin{wideitemize}
...
\begin{frame}{Collusion and Price Wars: Motivation}
	\begin{wideitemize}
		...
		\end{wideitemize}
		\item Key to many agreements: \textbf{dynamic considerations} \pause
		\begin{wideitemize}
	...
	\begin{columns}[onlytextwidth, T] 
		\begin{column}{.55\textwidth}
			\begin{wideitemize}
				...
				\item What would the firms prefer if they could coordinate? \pause Both firms would do much better if could somehow agree to play (T,L)
			\end{wideitemize}
		\end{column}
...
\begin{frame}{Repeated games}
	\begin{wideitemize}
		\item Why does the equilibrium in the repeated game differ from the one period game? \pause
