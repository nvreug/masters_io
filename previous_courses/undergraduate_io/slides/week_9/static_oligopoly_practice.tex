...
\begin{frame}{Hotelling Competition: Solution - 1. Get the payoffs}
	\begin{wideitemize}
		...
		\begin{align*}
			q_1 &= 0.5 + \frac{p_1 - p_2}{2t} \\
			q_2 &= 0.5 + \frac{p_2 - p_1}{2t} 
		\end{align*}
	\end{wideitemize}
\end{frame}
...
\begin{frame}{Hotelling Competition: Solution - 1. Get the payoffs}
	\begin{wideitemize}
		...
		\begin{align*}
			\pi_1 &= q_1 (p_1 - c_1) = (0.5 + \frac{p_1 - p_2}{2t})(p_1-c_1) \\
			\pi_2 &= q_2 (p_2 - c_2) = (0.5 + \frac{p_2 - p_1}{2t})(p_2-c_2) \\
		\end{align*}
	\end{wideitemize}
\end{frame}
...
\begin{frame}{Hotelling Competition: Solution Discussion}
	\begin{wideitemize}
		\item Overall:
		\item \textbf{If price competition is very intense, then firms tend to locate far apart (high degree of differentation).} 
		\item \textbf{If price competition is not very intense, then firms tend to locate close to each other (low degree of differentiation).}
	\end{wideitemize}
\end{frame}
...
\begin{frame}{Hotelling Competition: Application - Strategic Trade Policy: Solution}
	\begin{wideitemize}
		...
		\item So, $\$1$ increase in subsidies results in a 66c decrease in Boeing's profit.
	\end{wideitemize}
\end{frame}
