...
\begin{wideitemize}
	...
	\begin{wideitemize}
		...
		\item If Firm 2 produces $q_2=0$ then the residual demand curve for Firm 1 is $P(q_1+0)=P(q_1)$.
...
\begin{frame}{Plan}
	\begin{wideenumerate}
		...
		\item Cournot competition: solution using a graph
		\item Cournot competition: solution using math
		\item \textbf{Connection between Bertrand competition and Cournot competition  (Next lecture...)}
	\end{wideenumerate}
\end{frame}
