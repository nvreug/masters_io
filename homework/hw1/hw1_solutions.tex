...
Parameter & OLS & 2SLS \\
\midrule
$\hat{\beta}_0$ (constant) & $-2.9665$ & $-2.8915$ \\
$\hat{\beta}_1$ (sugar) & $0.0463$ & $0.0483$ \\
$\hat{\alpha}$ (price) & $-10.2036$ & $-10.9449$ \\
\bottomrule
\end{tabular}
\end{center}
...
There is a \textbf{negative linear relationship} between prices and elasticities.
...
Parameter & Estimate \\
\midrule
$\hat{\beta}_0$ (constant) & $-3.7933$ \\
$\hat{\alpha}_0$ (price) & $-3.1154$ \\
$\hat{\beta}_{0,inc}$ (constant $\times$ income) & $4.9601$ \\
$\hat{\alpha}_{inc}$ (price $\times$ income) & $-37.9653$ \\
$\hat{\beta}_1$ (sugar $\times$ income) & $0.1336$ \\
\bottomrule
\end{tabular}
\end{center}
...
The tight linear relationship is now \textbf{broken}---the pattern is scattered.
...
Using 2SLS estimates with $\hat{\alpha} = -10.9449$:
...
\midrule
All products available & \$0.0538 \\
Without F1B04 & \$0.0526 \\
\midrule
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{q3c_cs_vs_share.png}
\caption{Consumer surplus impact vs.\ market share}
\end{figure}

\textbf{Product whose removal most harms consumers:} F2B19 (market share 10.0\%, CS change $-\$0.0096$).

\textbf{Product whose removal least harms consumers:} F4B10 (market share 0.07\%, CS change $-\$0.0001$).
