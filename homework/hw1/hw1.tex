...
\begin{itemize}
	...
	\item $\beta_0$: Constant (intercept)
...
\begin{align*}
	u_{ijt} = \beta_0 + (\beta_1 + \pi_1 \cdot \text{income}_i) \cdot \text{sugar}_{jt} + (\alpha + \pi_\alpha \cdot \text{income}_i) \cdot p_{jt} + \xi_{jt} + \epsilon_{ijt}
\end{align*}
