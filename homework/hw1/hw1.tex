...
\begin{align*}
	u_{ijt} = (\beta_1 + \beta_{1,inc} \cdot \text{income}_i) \cdot \text{sugar}_{jt} + (\alpha_0 + \alpha_{inc} \cdot \text{income}_i) \cdot p_{jt} + \xi_{jt} + \epsilon_{ijt}
\end{align*}

This model has four parameters:
\begin{itemize}
	\item \textbf{Linear parameters:} $\beta_1$ (sugar), $\alpha_0$ (price)
