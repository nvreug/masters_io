...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PART 1: INTRODUCTION AND PRICING
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{transitionframe}
	\begin{center}
		{\Huge Part 1: Introduction and Pricing}
	\end{center}
\end{transitionframe}
...
\begin{frame}{Assessment}
	...
	\vspace{11pt}
	\begin{wideitemize}
		\item Exams: 70 minutes, calculator + one two-sided cheat sheet allowed
	\end{wideitemize}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PART 2: UTILITY MODELS AND DEMAND
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{transitionframe}
	\begin{center}
		{\Huge Part 2: Utility Models and Demand}
	\end{center}
\end{transitionframe}
