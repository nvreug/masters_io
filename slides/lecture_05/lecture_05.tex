...
\begin{frame}{Classic example: Intel 486 processor}
	\begin{wideitemize}
		...
		\item 486SX costs more to produce (extra step to disable)
		\item \textbf{Why?}
		\begin{wideitemize}
			\vspace{5pt}
...
\begin{frame}{Worked example: Two-part tariff (solution)}
	\begin{wideitemize}
		...
		\begin{wideitemize}
			\vspace{3pt}
			\item Inverse demand: $p = 6 - 0.4q$, so $\pi = (6 - 0.4q)q = 6q - 0.4q^2$
			\item FOC: $\frac{d\pi}{dq} = 6 - 0.8q = 0 \Rightarrow q = 7.5$
			\item Price: $p = 6 - 0.4(7.5) = 3$
