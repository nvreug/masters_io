...
\begin{frame}{Plan}
  \begin{wideenumerate}
    \item \textbf{Collusion refresher (from ECN 532)}
...
\begin{frame}{Plan}
  \begin{wideenumerate}
    ...
    \item \textbf{Critical discount factor with $N$ firms}
    \item Cournot vs Bertrand collusion
    \item[] \rule{0.5\textwidth}{0.4pt}
    \item Detection and fines
    \item Leniency programs
...
\begin{frame}{Plan}
  \begin{wideenumerate}
    \item Collusion refresher (from ECN 532)
    \item Critical discount factor with $N$ firms
    \item \textbf{Cournot vs Bertrand collusion}
    \item[] \rule{0.5\textwidth}{0.4pt}
    \item Detection and fines
    \item Leniency programs
    \item Antitrust enforcement
...
\begin{frame}{Plan}
  \begin{wideenumerate}
    ...
    \item Cournot vs Bertrand collusion
    \item[] \rule{0.5\textwidth}{0.4pt}
    \item \textbf{Detection and fines}
    \item Leniency programs
    \item Antitrust enforcement
  \end{wideenumerate}
\end{frame}
...
\begin{frame}{Plan}
  \begin{wideenumerate}
    ...
    \item Detection and fines
    \item Leniency programs
    \item \textbf{Antitrust enforcement}
  \end{wideenumerate}
\end{frame}
