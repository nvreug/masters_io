...
\begin{frame}{Plan}
  \begin{wideenumerate}
    \item \textbf{The Logit Demand Model}
    \item Identification and Instrumental Variables
  \end{wideenumerate}
\end{frame}
...
\begin{frame}{Plan}
  \begin{wideenumerate}
    \item The Logit Demand Model
    \item \textbf{Identification and Instrumental Variables}
  \end{wideenumerate}
\end{frame}
