...
\begin{frame}{Plan}
  \begin{wideenumerate}
    \item \textbf{Cournot and Bertrand competition}
    \item Product differentiation and Hotelling model
  \end{wideenumerate}
\end{frame}
...
\begin{frame}{Plan}
  \begin{wideenumerate}
    \item Cournot and Bertrand competition
    \item \textbf{Product differentiation and Hotelling model}
  \end{wideenumerate}
\end{frame}
