...
\begin{frame}{Plan}
  \begin{wideenumerate}
    \item \textbf{Vertical relationships and double marginalization}
    \item Vertical restraints and antitrust
  \end{wideenumerate}
\end{frame}
...
\begin{frame}{Plan}
  \begin{wideenumerate}
    \item Vertical relationships and double marginalization
    \item \textbf{Vertical restraints and antitrust}
  \end{wideenumerate}
\end{frame}
